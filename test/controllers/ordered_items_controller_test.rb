...
class OrderedItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordered_item" do
    assert_difference('OrderedItem.count') do
      post ordered_items_url, params: { ordered_item: { menu_item_id: @ordered_item.menu_item_id, order_id: @ordered_item.order_id, quantity: @ordered_item.quantity } }
    end
  ...
  test "should update ordered_item" do
    patch ordered_item_url(@ordered_item), params: { ordered_item: { menu_item_id: @ordered_item.menu_item_id, order_id: @ordered_item.order_id, quantity: @ordered_item.quantity } }
